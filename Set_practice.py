...
*>> set is a collection which is ordered and changeable. Allows duplicate members.
*>> set is a collection which is ordered and unchangeable. Allows duplicate members.
